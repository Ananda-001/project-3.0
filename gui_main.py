...
class HomeScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.place_button(0.68, 0.33, 'Button 2', 40)  # red color, font size 18
    ...
    def on_button_press(self, instance, button_label):
        ...
        if button_label == "Forgot Password":
            self.delete_widget_by_label("Button 2")
        ...
        if button_label == "Next":
            ...
            self.add_styled_text_input(0.42, 0.56, 'Username')
            self.add_styled_text_input(0.42, 0.38, 'Password')
        if button_label == 'Button 2' and User_check.check(username,password) == "access granted":
            ...
            global page
            page=1
        if button_label == 'Button 2' and User_check.check(username, password) == "access denied":
